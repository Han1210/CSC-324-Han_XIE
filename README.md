...
The data from Cause of Deaths around the World (Historical Data) on the Kaggle website. (Data Source: https://www.kaggle.com/datasets/iamsouravbanerjee/cause-of-deaths-around-the-world) It involves the data of different causes of death from 1990 to 2019 in different countries or regions.
...
The data frame about the world population analysis is sourced from Kaggle. (data source: https://www.kaggle.com/code/hasibalmuzdadid/world-population-analysis/notebook) Data involves the population of the world based on different regions and continents.
...
# Questions
I am trying to understand how different causes of death affect the 
